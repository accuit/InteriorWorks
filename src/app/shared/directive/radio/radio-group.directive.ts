...
import { IgxRadioComponent, RadioLabelPosition, IChangeRadioEventArgs } from '../../components/radio-button/radio-button.component';
...
*/
@Directive({
  selector: 'ipx-radio-group, [ipxRadioGroup]',
